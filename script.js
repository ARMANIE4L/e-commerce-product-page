document.addEventListener("DOMContentLoaded", function (event) {
    ...
    let toggleButtonCont = document.querySelector("#toggleButtonCont");
   ...
   // CHANGE THE BACKGROUND COLOR
    ...
    toggleButtonCont.classList.toggle("active");

    navbarContainer.classList.toggle("active");

    cartContentDisplayBox.classList.toggle("active")

}



toggleButtonCont.addEventListener("click", function () {

    toggleTheme();

    // CHANGE TOGGLE TEXT

    if (toggleButtonCont.classList.contains("active")) {

        toggleButtonCont.innerHTML = '<img src="./images/white-moon-icon.svg" class="toggle-button">'

    } else {

        toggleButtonCont.innerHTML = '<img src="./images/moon-icon.svg" class="toggle-button">'
...
navbarToggle.addEventListener("click", function () {
    ...
    navbarContainer.style.cssText = 'position: absolute; left: 0; top: 0;  height: 100vh; width: 60%;';
